...
/**
 * Servlet implementation class BlogManagerShowServlet
 */
@WebServlet("/Servlet/QueryBlogToblogmanagerServlet")
public class QueryBlogToblogmanagerServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/view/blogmanager.jsp").forward(request, response);
